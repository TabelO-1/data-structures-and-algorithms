...
given an array of strings, uses map to return a 
new array containing each string followed by a 
...
You may choose to complete this challenge using a 
for loop, for...in syntax, or for...of syntax.
...
function from challenge 4, but uses forEach 
...
from challenge 5, but uses map instead of a for 
loop or forEach.
------------------------------------------------------------------------------------------------ */
...
Write a function named extractAbilities that, given the array of abilities, uses map to 
create an array containing only the ability name.
